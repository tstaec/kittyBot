...
function kittyBotGo() {
    ...
    // MEGA CHEAT: Keep Catnip Maxed
    if (document.getElementById('kb_gatherMax').checked) { if (kb_rCatnip.value < kb_rCatnip.maxValue) { kb_rCatnip.value = kb_rCatnip.maxValue; } }
...
'<input id="kb_gatherMax" type="radio" name="kb_gather" style="vertical-align: sub;" />Keep catnip maxed (mega-cheat)<br />'+
'</div>'+
'</div>'+
'';
